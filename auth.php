        ...
        <div class="row" id="auth-row">
            <div class="col-md-4" id="login-container">
                ...
                <input type="hidden" name="type" value="login">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password" name="password" placeholder="Digite seu senha">
                    </div>
            ...
            <div class="col-md-4" id="register-container">
                ...
                <form action="<?= $BASE_URL ?>auth_process.php" method="POST" class="form-register-login">
                    ...
                    <input type="submit" class="btn card-btn mt-4" value="Cadastrar">
                </form>
            </div>
        </div>
    </div>
